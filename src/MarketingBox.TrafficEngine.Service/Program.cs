...
using MarketingBox.TrafficEngine.Service.Settings;
...
namespace MarketingBox.TrafficEngine.Service
{
    ...
    {
        public const string SettingsFileName = ".marketingboxtrafficengineservice";
        ...
        {
            Console.Title = "MyJetWallet MarketingBox.TrafficEngine.Service";
